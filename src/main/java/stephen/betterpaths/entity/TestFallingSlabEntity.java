//package stephen.betterpaths.entity;
//
...
//
//public class TestFallingSlabEntity
//        extends FallingBlockEntity {
//    private static final Logger LOGGER = LogUtils.getLogger();
//    private BlockState block = ModBlocks.SAND_SLAB.getDefaultState();
...
//    protected static final TrackedData<BlockPos> BLOCK_POS = DataTracker.registerData(net.minecraft.entity.FallingBlockEntity.class, TrackedDataHandlerRegistry.BLOCK_POS);
//
//    public TestFallingSlabEntity(EntityType<? extends FallingBlockEntity> entityType, World world) {
//        super(entityType, world);
//    }
//
//    private TestFallingSlabEntity(World world, double x, double y, double z, BlockState block) {
...
//     */
//    public static TestFallingSlabEntity spawnFromBlock(World world, BlockPos pos, BlockState state) {
//        TestFallingSlabEntity testFallingSlabEntity = new TestFallingSlabEntity(world, (double)pos.getX() + 0.5, pos.getY(), (double)pos.getZ() + 0.5, state.contains(Properties.WATERLOGGED) ? (BlockState)state.with(Properties.WATERLOGGED, false) : state);
//        world.setBlockState(pos, state.getFluidState().getBlockState(), Block.NOTIFY_ALL);
//        world.spawnEntity(testFallingSlabEntity);
//        return testFallingSlabEntity;
//    }
//
//    @Override
...
//                        boolean bl3setToTrue = false;
//
//                        if (!bl3){
//                            if (this.getWorld().getBlockState(this.getFallingBlockPos().down()).isOf(this.block.getBlock()) && this.getWorld().getBlockState(this.getFallingBlockPos().down()).get(TYPE) == SlabType.BOTTOM){
//                                bl3 = true;
//                                bl3setToTrue = true;
//                            }
//                        }
...
//                                this.getWorld().setBlockState(this.getBlockPos(), this.getWorld().getBlockState(this.getBlockPos()).with(TYPE, SlabType.DOUBLE));
//                                this.discard();
...
//                                }
//                            }
//                            else if (this.getWorld().setBlockState(blockPos, this.block, Block.NOTIFY_ALL)) {
//                                BlockEntity blockEntity;
