...
//
//public class FallingGravelSlabEntity extends FallingBlockEntity {
...
//    public FallingGravelSlabEntity(EntityType<? extends FallingBlockEntity> entityType, World world) {
//        super(entityType, world);
//    }
//    private FallingGravelSlabEntity(World world, double x, double y, double z, BlockState block) {
...
//    }
//
//    public static FallingGravelSlabEntity spawnFromBlock(World world, BlockPos pos, BlockState state) {
//        FallingGravelSlabEntity fallingGravelSlabEntity = new FallingGravelSlabEntity(world, (double)pos.getX() + 0.5, pos.getY(), (double)pos.getZ() + 0.5, state.contains(Properties.WATERLOGGED) ? state.with(Properties.WATERLOGGED, false) : state);
//        world.setBlockState(pos, state.getFluidState().getBlockState(), Block.NOTIFY_ALL);
//        world.spawnEntity(fallingGravelSlabEntity);
//        return fallingGravelSlabEntity;
//    }
//    @Override
...
//                            }
//                        } else {
//                            if (this.getWorld().getBlockState(this.getBlockPos()).getBlock() instanceof GravelSlabTest && this.getWorld().getBlockState(this.getBlockPos()).get(TYPE) == SlabType.BOTTOM){
