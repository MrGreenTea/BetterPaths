...
//
//public class FallingSandSlabEntity extends FallingBlockEntity {
...
//    public FallingSandSlabEntity(EntityType<? extends FallingBlockEntity> entityType, World world) {
//        super(entityType, world);
//    }
//    private FallingSandSlabEntity(World world, double x, double y, double z, BlockState block) {
...
//    }
//
//    public static FallingSandSlabEntity spawnFromBlock(World world, BlockPos pos, BlockState state) {
//        FallingSandSlabEntity fallingSandSlabEntity = new FallingSandSlabEntity(world, (double)pos.getX() + 0.5, pos.getY(), (double)pos.getZ() + 0.5, state.contains(Properties.WATERLOGGED) ? state.with(Properties.WATERLOGGED, false) : state);
//        world.setBlockState(pos, state.getFluidState().getBlockState(), Block.NOTIFY_ALL);
//        world.spawnEntity(fallingSandSlabEntity);
//        return fallingSandSlabEntity;
//    }
//    @Override
...
//                            }
//                        } else {
//                            if (this.getWorld().getBlockState(this.getBlockPos()).getBlock() instanceof FallingSlab && this.getWorld().getBlockState(this.getBlockPos()).get(TYPE) == SlabType.BOTTOM){
